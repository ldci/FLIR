...
convertTool: "magick"		;--convertTool: "/usr/local/bin/convert"	
SourceFile: ""
tmpDir: none	

exifFile:  	%exif.txt		;--for decoding Flir image by exifTool
exifFile2: 	%exif.r3		;--to get Rebol words
...
"Get all Flir file metadata values as Red/Rebol words"
	...
	exifFile2: to-file rejoin [tmpDir "exif.r3"]
...
"All the values we need for temperature computation"
	...
	tmpREF: 	to-decimal trim/with str " C"
